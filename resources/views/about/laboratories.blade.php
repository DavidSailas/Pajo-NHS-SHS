...
@section('content')
    ...
    <section class="bg-gradient-to-br from-green-950 to-green-900 text-white py-16">
        <div class="max-w-6xl mx-auto px-4 text-center">
            <h1 class="text-3xl md:text-5xl font-extrabold tracking-tight mb-4">School Laboratories</h1>
            <p class="text-green-100 max-w-xl mx-auto text-base font-light">Hands-on spaces designed for experiential learning and practical competencies.</p>
        </div>
    </section>

    {{-- LABORATORIES --}}
    <section id="laboratories" class="bg-gray-50 py-16 scroll-mt-32">
